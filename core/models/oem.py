...
class OemWord(models.Model):
    ...
    thesaurus = models.ManyToManyField('self', through='OemThesaurus', symmetrical=False, related_name='related_thesaurus_entries')
    similar = models.ManyToManyField('self', through='OemSimilar', symmetrical=False, related_name='related_similar_entries')
...
class OemThesaurus(models.Model):
    from_word = models.ForeignKey(OemWord, on_delete=models.CASCADE, db_column='wrid', related_name='from_thesaurus')
...
class OemSimilar(models.Model):
    from_word = models.ForeignKey(OemWord, on_delete=models.CASCADE, db_column='wrid', related_name='from_similar')
...
class OemAntonym(models.Model):
    from_word = models.ForeignKey(OemWord, on_delete=models.CASCADE, db_column='wrid', related_name='from_antonym')
